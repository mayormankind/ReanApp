...
import { PageWrapper, Loading } from '../chakra/Styles'
...
export default function Profile() {
  ...
  return (
    <PageWrapper activeLink={'Profile'}>
        {activeUser===undefined ? <Loading/> : <Flex m='auto' flexDir='column' h='100vh' w='100%' bg='greenBg' overflowY='scroll' gap='10px'>
